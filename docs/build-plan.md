...
3. **10–18 Spec the rig** — **Lee's recommendation (LOCKED, 2026-07-12): Isuzu NPR-HD, GAS motor, standard cab, backup camera, powered adjustable mirrors.** Verify exact current specs via web research before asserting (engine, HP, GVWR — expected well under 26,001 = non-CDL; payload; why gas over diesel for junk duty: maintenance cost/simplicity, no DEF/regen, fuel availability). GVWR/non-CDL teach, new vs used, chassis + STB body/upfit lead times, where to buy.
